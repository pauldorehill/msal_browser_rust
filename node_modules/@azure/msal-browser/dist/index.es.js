/*! @azure/msal-browser v2.0.0 2020-07-21 */
'use strict';
/*! *****************************************************************************
...
var PublicClientApplication = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        silentAuthUrlRequest = this.initializeAuthorizationRequest(__assign(__assign({}, silentRequest), { redirectUri: request.redirectUri, prompt: PromptValue.NONE }));
    ...
    PublicClientApplication.prototype.getAccountByUsername = function (userName) {
        ...
        return allAccounts ? allAccounts.filter(function (accountObj) { return accountObj.username.toLowerCase() === userName.toLowerCase(); })[0] : null;
    };
    // #endregion
    // #region Helpers
    /**
...
export { AuthError, AuthErrorMessage, AuthenticationResult, BrowserAuthError, BrowserAuthErrorMessage, BrowserConfigurationAuthError, BrowserConfigurationAuthErrorMessage, InteractionRequiredAuthError, LogLevel, Logger, PublicClientApplication };
